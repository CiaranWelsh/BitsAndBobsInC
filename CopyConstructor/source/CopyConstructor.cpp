/*
 * A copy constructor is a member function which initialised an object using another object of the same class.
 * A copy constructor has the general form:
 *      - ClassName(const ClassName &old_obj);
 *
 * A copy constructor is called when a new object is created from an existing one
